<%-- 
    Document   : index
    Created on : 09-jun-2018, 11:38:58
    Author     : Jeshua Banda
--%>
...
<head>
    ...
    <!-- Site Metas -->
    <title>J&J Catering Services E.I.R.L</title>
                ...
                <div class="banner-static">
                    <div class="banner-text">
                        <div class="banner-cell">
                            <h1>Cada evento es <span class="typer" id="some-id" data-delay="200" data-delim=":" data-words="Unico:Irrepetible:Emocionante" data-colors="red"></span><span class="cursor" data-cursorDisplay="_" data-owner="some-id"></span></h1>
                            <h2>Servicio Eficiente Superando Tus Expectativas</h2>
                            ...
                            <div class="book-btn">
                                ...
                                <a href="#reservation" class="table-btn hvr-underline-from-center">Login</a>
                            </div>
                            <a href="#about">
                                <div class="mouse"></div>
                            </a>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <h3>¿Quiénes somos?</h3>
                        <p> Somos una empresa de servicio de Catering personalizado, nos define la calidad y la especialización en la preparación de alimentos y bebidas. Garantizamos un servicio óptimo, basándonos en nuestro pilar corporativo, la satisfacción plena de nuestros clientes. </p>

                        <h3>¿Qué hacemos?</h3>
                        <p> Nos enfocamos en la elaboración y presentación de alimentos y bebidas de alta calidad. Diseñamos opciones de menúes personalizados y asesoramos a nuestros clientes, rigiéndonos por un proceso de evaluación desde el primer contacto hasta la entrega y/o ejecución del evento. </p>

                        <h3>Promesa</h3>
                        <p> Ofrecer una experiencia única, agregando elementos que acompañen nuestros servicios </p>
                    </div>
                </div>
                <!-- end col -->
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    ...
    <div class="special-menu pad-top-100 parallax">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <h2 class="block-title color-white text-center"> Servicios Especiales </h2>
                        <h5 class="title-caption text-center"> Si desea impresionar a sus invitados, debe aprovechar los servicios de alta calidad de nuestra empresa de catering. Sara Sharpe Catering ofrece la comida adecuada para bodas, eventos corporativos y cócteles. Contáctenos en Lima, Perú, para obtener más información acerca de nuestros servicios especiales de catering para eventos. </h5>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <p class="title-caption text-center">Nuestro equipo está conformado por más 85 especialistas comprometidos en brindar un servicio personalizado y de alta calidad. </p>
                    </div>
                    <div class="team-box">
        ...
        <div class="footer-box pad-top-70">
                    ...
                    <div class="footer-in-main">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box-a">
                                ...
                                <p>J&J Catering Services ha iniciado en el mercado de catering para eventos a todo Lima desde 2012.</p>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box-b">
                                <h3>Proximas Ofertas</h3>
                                <ul>
                                    <li><a href="#">Paquete de Fiestas Patrias</a></li>
                                    <li><a href="#">Noches de Bodas</a></li>
                                    <li><a href="#">Graduaciones</a></li>
                                    <li><a href="#">Cumpleaños dobles</a></li>
                                </ul>
                            </div>
                            <!-- end footer-box-b -->
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box-c">
                                ...
                                <p>
                                    ...
                                    <span>Av. los Alamos 141 Miraflores, Lima, Peru</span>
                                </p>
                                <p>
                                ...
                                <p>
                                    ...
                                    <span><a href="#">j&jcateringservices@gmail.com</a></span>
                                </p>
                            </div>
                            <!-- end footer-box-c -->
                        </div>
            ...
            <div id="copyright" class="copyright-main">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h6 class="copy-title"> Copyright &copy; 2018 J&J Catering Services es patrocinado por <a href="#" target="_blank">Autonoma Producciones</a> </h6>
                        </div>
                    </div>
                    <!-- end row -->
                </div>
