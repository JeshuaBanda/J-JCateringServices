...
(function($) {
    "use strict";
		...
		jQuery(".orange-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "images/logon.png");
			jQuery(".footer-logo .text-center img").attr("src", "images/logon.png");
			return false;
		});

		jQuery(".strong-blue-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "images/logon2.png");
			jQuery(".footer-logo .text-center img").attr("src", "images/logon2.png");
			return false;
		});

		jQuery(".moderate-green-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "images/logon3.png");
			jQuery(".footer-logo .text-center img").attr("src", "images/logon3.png");
			return false;
		});

		jQuery(".vivid-yellow-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "images/logon4.png");
			jQuery(".footer-logo .text-center img").attr("src", "images/logon4.png");
			return false;
		});
